...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Verification.verifier'
        db.add_column('app_verification', 'verifier',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='verifications_verified', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Verification.verifier'
        db.delete_column('app_verification', 'verifier_id')
