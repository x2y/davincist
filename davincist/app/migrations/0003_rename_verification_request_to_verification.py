...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('app_verificationrequest', 'app_verification')
        db.rename_column('app_wallpost', 'verification_request_id', 'verification_id')

    def backwards(self, orm):
        db.rename_column('app_wallpost', 'verification_id', 'verification_request_id')
        db.rename_table('app_verification', 'app_verificationrequest')
