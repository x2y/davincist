...
# debug     print "User: %s, XP: %s" % (user.user,user.xp)
      top_users.append(user)
# debug    print top_users
    sorted_users = sorted(top_users, key=attrgetter('xp'), reverse=True)
# debug    print "Sorted_users: %s" % (sorted_users)
    return sorted_users
