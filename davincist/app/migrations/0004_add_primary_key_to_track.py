...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_track', (
            ...
            ('backgrounds', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ))
        db.send_create_signal('app', ['Track'])

        # Changing field 'UserTrack.track'
        db.alter_column('app_usertrack', 'track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Track']))

        # Changing field 'Level.track'
        db.alter_column('app_level', 'track_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Track']))
