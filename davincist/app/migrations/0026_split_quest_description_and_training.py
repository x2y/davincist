...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Quest.training'
        db.add_column('app_quest', 'training',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


        # Changing field 'Quest.description'
        db.alter_column('app_quest', 'description', self.gf('django.db.models.fields.CharField')(max_length=128))

    def backwards(self, orm):
        # Deleting field 'Quest.training'
        db.delete_column('app_quest', 'training')


        # Changing field 'Quest.description'
        db.alter_column('app_quest', 'description', self.gf('django.db.models.fields.TextField')())
