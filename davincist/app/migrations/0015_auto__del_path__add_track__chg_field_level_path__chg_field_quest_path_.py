...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('app_path', 'app_track')
        db.send_create_signal('app', ['Track'])


        # Changing field 'Level.path'
        db.alter_column('app_level', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Track']))

        # Changing field 'Quest.path'
        db.alter_column('app_quest', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Track']))

        # Changing field 'UserPath.path'
        db.alter_column('app_userpath', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Track']))

    def backwards(self, orm):
        db.rename_table('app_track', 'app_path')
        db.send_create_signal('app', ['Path'])

        # Changing field 'Level.path'
        db.alter_column('app_level', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Path']))

        # Changing field 'Quest.path'
        db.alter_column('app_quest', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Path']))

        # Changing field 'UserPath.path'
        db.alter_column('app_userpath', 'path_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Path']))
    ...
    models = {
        ...
        'app.level': {
            ...
            'is_public': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'path': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'levels'", 'to': "orm['app.Track']"}),
        ...
        'app.quest': {
            ...
            'path': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'quests'", 'to': "orm['app.Track']"}),
        ...
        'app.userpath': {
            ...
            'mission': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'path': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_paths'", 'to': "orm['app.Track']"}),
