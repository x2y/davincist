...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_badge', 'level',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Level'], null=True, blank=True),
                      keep_default=False)
        if not db.dry_run:
          for badge in orm.Badge.objects.all():
            badge.level = badge.levels_needing.all()[0]
            badge.save()
    ...
    models = {
        'app.badge': {
            ...
            'level': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['app.Level']", 'null': 'True', 'blank': 'True'}),
