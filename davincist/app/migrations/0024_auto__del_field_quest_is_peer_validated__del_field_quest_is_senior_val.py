...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quest.is_peer_validated'
        db.delete_column('app_quest', 'is_peer_validated')

        # Deleting field 'Quest.is_senior_validated'
        db.delete_column('app_quest', 'is_senior_validated')


    def backwards(self, orm):
        # Adding field 'Quest.is_peer_validated'
        db.add_column('app_quest', 'is_peer_validated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Quest.is_senior_validated'
        db.add_column('app_quest', 'is_senior_validated',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
