...
urlpatterns = patterns('',
    ...
    url(r'(?i)^p/%s/quest/%s/$' % (PATH_GROUP, QUEST_GROUP), quest_detail, name='quest_detail'),
    url(r'(?i)^p/%s/quest/%s/submit/$' % (PATH_GROUP, QUEST_GROUP), quest_submit, name='quest_submit'),
    url(r'(?i)^p/%s/quest/%s/verify/$' % (PATH_GROUP, QUEST_GROUP), quests_verify, name='quests_verify'),
    url(r'(?i)^p/%s/quest/%s/verify/%s/$' % (PATH_GROUP, QUEST_GROUP, USER_GROUP), quest_verify, name='quest_verify'),
    ...
    url(r'(?i)^u/%s/about/$' % USER_GROUP, user_detail, name='user_detail'),
