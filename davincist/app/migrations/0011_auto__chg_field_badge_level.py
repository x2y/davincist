...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Badge.level'
        db.alter_column('app_badge', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['app.Level']))

    def backwards(self, orm):

        # Changing field 'Badge.level'
        db.alter_column('app_badge', 'level_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['app.Level'], null=True))
