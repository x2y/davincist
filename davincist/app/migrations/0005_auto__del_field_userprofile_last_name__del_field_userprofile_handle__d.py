...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('app_userprofile', 'last_name')

        # Deleting field 'UserProfile.handle'
        db.delete_column('app_userprofile', 'handle')

        # Deleting field 'UserProfile.first_name'
        db.delete_column('app_userprofile', 'first_name')

        # Deleting field 'UserProfile.created'
        db.delete_column('app_userprofile', 'created')

        # Deleting field 'UserProfile.email'
        db.delete_column('app_userprofile', 'email')

        # Deleting field 'UserProfile.last_seen'
        db.delete_column('app_userprofile', 'last_seen')


        # Changing field 'UserProfile.user'
        db.alter_column('app_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, primary_key=True))

    def backwards(self, orm):
        # Adding field 'UserProfile.last_name'
        db.add_column('app_userprofile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

        # Adding field 'UserProfile.handle'
        db.add_column('app_userprofile', 'handle',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, primary_key=True),
                      keep_default=False)

        # Adding field 'UserProfile.first_name'
        db.add_column('app_userprofile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

        # Adding field 'UserProfile.created'
        db.add_column('app_userprofile', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.email'
        db.add_column('app_userprofile', 'email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75),
                      keep_default=False)

        # Adding field 'UserProfile.last_seen'
        db.add_column('app_userprofile', 'last_seen',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


        # Changing field 'UserProfile.user'
        db.alter_column('app_userprofile', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True))
