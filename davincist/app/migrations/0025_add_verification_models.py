...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_verificationrequest', (
            ...
            ('quest', self.gf('django.db.models.fields.related.ForeignKey')(related_name='verification_requests', to=orm['app.Quest'])),
        ...
        # Adding unique constraint on 'VerificationRequest', fields ['user', 'quest']
        db.create_unique('app_verificationrequest', ['user_id', 'quest_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'VerificationRequest', fields ['user', 'quest']
        db.delete_unique('app_verificationrequest', ['user_id', 'quest_id'])
