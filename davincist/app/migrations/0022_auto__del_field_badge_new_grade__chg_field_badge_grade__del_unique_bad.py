...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('app_badge', 'grade')

        db.rename_column('app_badge', 'new_grade', 'grade')
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Badge.grade'
        db.alter_column('app_badge', 'grade', self.gf('django.db.models.fields.CharField')(max_length='1'))
