...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('app_invitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('secret', self.gf('django.db.models.fields.CharField')(default='a surgically rapscallion shebang', max_length=75)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('emails_sent', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('last_email_timestamp', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('claimer', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='invitation', unique=True, null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('app', ['Invitation'])


    def backwards(self, orm):
        # Deleting model 'Invitation'
        db.delete_table('app_invitation')
    ...
    models = {
        ...
        'app.invitation': {
            ...
            'secret': ('django.db.models.fields.CharField', [], {'default': "'a sporadically greasy waddle'", 'max_length': '75'})
        },
        'app.level': {
