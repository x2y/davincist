...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'UserPath', fields ['user']
        db.delete_unique('app_userpath', ['user_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'UserPath', fields ['user']
        db.create_unique('app_userpath', ['user_id'])
