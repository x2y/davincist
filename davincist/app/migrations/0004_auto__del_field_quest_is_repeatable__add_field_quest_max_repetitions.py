...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Quest.is_repeatable'
        db.delete_column('app_quest', 'is_repeatable')

        # Adding field 'Quest.max_repetitions'
        db.add_column('app_quest', 'max_repetitions',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Quest.is_repeatable'
        db.add_column('app_quest', 'is_repeatable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Quest.max_repetitions'
        db.delete_column('app_quest', 'max_repetitions')
