...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.delete_unique('app_userpath', ['user_id', 'track_id'])

        db.rename_table('app_userpath', 'app_usertrack')

        db.delete_unique('app_userpath_badges', ['userpath_id', 'badge_id'])
        db.rename_table('app_userpath_badges', 'app_usertrack_badges')
        db.rename_column('app_usertrack_badges', 'userpath_id', 'usertrack_id')
